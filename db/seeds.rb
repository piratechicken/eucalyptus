...
16.times do
  ...
  Listing.create!(title: title, user: users.sample, specie: species, price_cents: rand(500..20000), description: 'Here is my listing description: lalala blah yada.', active: true )
end